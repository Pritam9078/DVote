...
class PinataService {
  ...
  async pinJSON(data, name) {
    try {
      ...
      if (!authHeaders) {
        console.warn('[DVote] No valid Pinata credentials found. Using mock IPFS hash.');
        return {
          success: true,
      ...
      console.warn('[DVote] Pinata upload failed. Using mock IPFS hash for development.');
  ...
  async pinFile(file, name) {
    try {
      ...
      const authHeaders = this.getAuthHeaders();
      if (!authHeaders) {
        console.warn('[DVote] No valid Pinata credentials found. Using mock IPFS hash for file.');
        return {
          success: true,
      ...
      console.warn('[DVote] Pinata file upload failed. Using mock IPFS hash for development.');
