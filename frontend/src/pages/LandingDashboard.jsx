...
const LandingDashboard = () => {
  ...
  const faqs = [
    {
      question: 'What is DVote DAO?',
      answer: 'DVote DAO is a decentralized autonomous organization that enables community-driven governance through blockchain technology. Members can propose, vote, and implement changes to the protocol.'
    },
    {
      question: 'How do I participate in governance?',
      answer: 'To participate, you need DVT tokens. Connect your wallet, acquire tokens, and you can start voting on proposals or create your own proposals for the community to consider.'
    },
    {
      question: 'What are the voting requirements?',
      answer: 'Any DVT token holder can vote. The weight of your vote is proportional to your token holdings. There are no minimum requirements to participate in governance decisions.'
    },
    {
      question: 'How are proposals executed?',
      answer: 'Once a proposal passes with majority support and meets quorum requirements, it is automatically executed through smart contracts, ensuring transparent and tamper-proof implementation.'
    }
  ];
  ...
  const features = [
    {
      ...
      description: 'Create and vote on proposals that shape the future of the DAO',
    ...
    },
    {
      ...
      description: 'All governance actions are recorded on-chain for full transparency',
    ...
    },
    {
      ...
      description: 'Optimized smart contracts for gas-efficient governance operations',
    ...
    },
    {
      ...
      description: 'Anyone with tokens can participate from anywhere in the world',
            ...
            <div className="text-center">
              <div className="flex items-center justify-center mb-8">
                ...
                <div className="ml-6 text-left">
                  ...
                  <p className="text-xl text-gray-600 font-medium">Decentralized Governance Platform</p>
                </div>
              </div>
              
              <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                A fully on-chain governance platform for decentralized autonomous organizations. 
                Participate in proposals, vote on important decisions, and help shape the future of decentralized governance.
              </p>
                  ...
                  <div className="relative bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8 text-center border border-gray-100 hover:border-transparent transition-all duration-300">
                    <div className={`w-14 h-14 bg-gradient-to-br ${stat.gradient} rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg`}>
                      {stat.icon === 'custom-logo' ? (
                        <img src="/dvote-logo.png" alt="DVote Logo" className="w-8 h-8 object-contain" />
                      ) : (
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-20">
              ...
              <h2 className="text-5xl font-black text-gray-900 mb-6">
                Built for the Future of <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Governance</span>
              </h2>
                    ...
                    <div className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 h-full">
                      <div className={`w-16 h-16 bg-gradient-to-br ${feature.color} rounded-xl flex items-center justify-center mb-6 shadow-lg transform group-hover:scale-110 transition-transform duration-300`}>
                        {feature.icon === 'custom-logo' ? (
                          <img src="/dvote-logo.png" alt="DVote Logo" className="w-10 h-10 object-contain" />
                        ) : (
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600">
                Join thousands in shaping decentralized governance
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: 'Securely link your Web3 wallet to access the governance platform',
                  icon: Lock,
                  color: 'from-indigo-500 to-blue-600'
                },
                {
                  step: '2',
                  title: 'Get DVT Tokens',
                  description: 'Acquire governance tokens to unlock your voting power in the DAO',
                  icon: Coins,
                ...
                },
                {
                  ...
                  description: 'Create proposals, cast votes, and actively shape the ecosystem',
                  icon: Activity,
        ...
        <section className="relative py-24 bg-gradient-to-b from-white/50 to-slate-50/50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-20">
              ...
              <h2 className="text-5xl font-black text-gray-900 mb-6">
                Real-Time <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Governance Stats</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Track the pulse of our decentralized community with live governance metrics and participation data.
              </p>
            </div>
        ...
        <section className="relative py-24 bg-gradient-to-br from-slate-50 to-indigo-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Understand the tokenomics behind DVote DAO and how DVT tokens power our governance ecosystem.
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h4 className="text-lg font-bold text-gray-900">Governance Rights</h4>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Get rewarded for active governance participation</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-6 text-white">
                  ...
                  <p className="mb-4 opacity-90">Acquire DVT tokens and join our governance community today.</p>
        ...
        <section className="relative py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Everything you need to know about DVote DAO governance and participation.
              </p>
            </div>
          ...
          <div className="relative max-w-4xl mx-auto px-4 text-center">
            <div>
              ...
              <p className="text-xl text-indigo-100 mb-10 max-w-2xl mx-auto leading-relaxed">
                Join the DVote DAO community and start participating in decentralized governance today. 
                Your voice matters.
              </p>
              <ConnectButton.Custom>
                {({ openConnectModal }) => (
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <div className="ml-4 text-left">
                ...
                <p className="text-lg text-gray-600 font-medium">Welcome Back, Governance Leader!</p>
              </div>
            </div>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Shape the future through decentralized decision-making and community-driven governance
            </p>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8 border border-gray-100">
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-lg font-medium">Recent governance activity will appear here</p>
                <p className="text-gray-400 text-sm mt-2">Start by creating or voting on proposals</p>
              </div>
            </div>
          </div>
        </div>
