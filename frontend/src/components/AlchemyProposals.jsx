...
const AlchemyProposals = () => {
   ...
   */
    ...
    try {
      ...
      // Create provider using local node (since you're using local addresses)
      ...
      // Create contract instance with your local DAO address
      const daoContract = new ethers.Contract(
        CONTRACT_ADDRESSES.DAO, // Using your local contract address
        DAO_ABI, 
        provider
      );
      ...
      setError('Failed to connect to blockchain. Make sure your local node is running on port 8545.');
    } finally {
      setLoading(false);
    }
  };
