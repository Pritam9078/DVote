...
const Navbar = () => {
  ...
  // Define specific admin wallet addresses
  ...
  if (address) {
    ...
    console.log('📝 To enable admin panel: Add this address to adminAddresses array in Navbar.jsx');
  }
          ...
          <div className="flex items-center min-w-0 flex-1">
            ...
            <Link to="/" className="flex items-center space-x-2 flex-shrink-0">
              ...
              >
                ...
                />
                <div 
                  className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-sm hidden"
                >
                  D
                </div>
              </motion.div>
              <h1 className="text-xl font-bold text-blue-600 hidden sm:block">DVote</h1>
            </Link>
