...
export default function CreateProposal() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('[DVote] Current state:', {
      ...
      isSepolia: currentChainId === 11155111,
      contractsObject: CONTRACTS
    });

    // Validate network - support both localhost and Sepolia
    if (currentChainId !== 31337 && currentChainId !== 11155111) {
      console.log('[DVote] ❌ Wrong network:', currentChainId);
      showToast('Please switch to localhost (31337) or Sepolia (11155111) network in your wallet.', 'error');
      return;
    }
    ...
    if (currentChainId === 31337) {
      ...
      finalContractAddress = SEPOLIA_ADDRESSES.DAO;
      console.log('[DVote] 🔄 Using Sepolia DAO address:', finalContractAddress);
    }
